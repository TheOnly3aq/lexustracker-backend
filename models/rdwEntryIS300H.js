...
const RdwEntryIS300HSchema = new mongoose.Schema(
  {
...
RdwEntryIS300HSchema.index({ kenteken: 1 }, { unique: true });
RdwEntryIS300HSchema.index({ lastUpdated: -1 });

module.exports = mongoose.model("RdwEntryIS300H", RdwEntryIS300HSchema, "rdwentries_is300h");